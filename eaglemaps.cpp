...
void EagleMaps::initializeMap() {
    ...
    // Vann connections
    campusMap.addEdge(vann, scott, 0.4);
    campusMap.addEdge(vann, luckyday, 0.4);
    campusMap.addEdge(vann, cpn, 0.5);
    campusMap.addEdge(vann, mccarty, 0.3);
    campusMap.addEdge(vann, wilber, 0.3);
    campusMap.addEdge(vann, hillcrest, 0.6);
    campusMap.addEdge(vann, thad, 0.4);
    campusMap.addEdge(vann, library, 0.2);
    campusMap.addEdge(vann, mathZone, 0.2);
    campusMap.addEdge(vann, liberalArts, 0.4);
    campusMap.addEdge(vann, asbury, 0.4);
    campusMap.addEdge(vann, lucas, 0.1);
    campusMap.addEdge(vann, elizabeth, 0.4);
    campusMap.addEdge(vann, honorBusiness, 0.2);
    
    // Scott connections
    campusMap.addEdge(scott, luckyday, 0.2);
    campusMap.addEdge(scott, cpn, 0.3);
    campusMap.addEdge(scott, mccarty, 0.2);
    campusMap.addEdge(scott, wilber, 0.6);
    campusMap.addEdge(scott, hillcrest, 0.3);
    campusMap.addEdge(scott, thad, 0.3);
    campusMap.addEdge(scott, library, 0.4);
    campusMap.addEdge(scott, mathZone, 0.4);
    campusMap.addEdge(scott, liberalArts, 0.6);
    campusMap.addEdge(scott, asbury, 0.7);
    campusMap.addEdge(scott, lucas, 0.6);
    campusMap.addEdge(scott, elizabeth, 0.7);
    campusMap.addEdge(scott, honorBusiness, 0.5);
    
    // Luckyday connections
    campusMap.addEdge(luckyday, cpn, 0.4);
    campusMap.addEdge(luckyday, mccarty, 0.2);
    campusMap.addEdge(luckyday, wilber, 0.5);
    campusMap.addEdge(luckyday, hillcrest, 0.4);
    campusMap.addEdge(luckyday, thad, 0.1);
    campusMap.addEdge(luckyday, library, 0.3);
    campusMap.addEdge(luckyday, mathZone, 0.3);
    campusMap.addEdge(luckyday, liberalArts, 0.5);
    campusMap.addEdge(luckyday, asbury, 0.6);
    campusMap.addEdge(luckyday, lucas, 0.5);
    campusMap.addEdge(luckyday, elizabeth, 0.6);
    campusMap.addEdge(luckyday, honorBusiness, 0.5);
    
    // CPN connections
    campusMap.addEdge(cpn, mccarty, 0.2);
    campusMap.addEdge(cpn, wilber, 0.7);
    campusMap.addEdge(cpn, hillcrest, 0.3);
    campusMap.addEdge(cpn, thad, 0.4);
    campusMap.addEdge(cpn, library, 0.5);
    campusMap.addEdge(cpn, mathZone, 0.4);
    campusMap.addEdge(cpn, liberalArts, 0.6);
    campusMap.addEdge(cpn, asbury, 0.7);
    campusMap.addEdge(cpn, lucas, 0.6);
    campusMap.addEdge(cpn, elizabeth, 0.7);
    campusMap.addEdge(cpn, honorBusiness, 0.6);
    
    // Mccarty connections
    campusMap.addEdge(mccarty, wilber, 0.4);
    campusMap.addEdge(mccarty, hillcrest, 0.2);
    campusMap.addEdge(mccarty, thad, 0.3);
    campusMap.addEdge(mccarty, library, 0.5);
    campusMap.addEdge(mccarty, mathZone, 0.5);
    campusMap.addEdge(mccarty, liberalArts, 0.6);
    campusMap.addEdge(mccarty, asbury, 0.7);
    campusMap.addEdge(mccarty, lucas, 0.5);
    campusMap.addEdge(mccarty, elizabeth, 0.7);
    campusMap.addEdge(mccarty, honorBusiness, 0.4);
    
    // Wilber connections
    campusMap.addEdge(wilber, hillcrest, 0.5);
    campusMap.addEdge(wilber, thad, 0.6);
    campusMap.addEdge(wilber, library, 0.4);
    campusMap.addEdge(wilber, mathZone, 0.5);
    campusMap.addEdge(wilber, liberalArts, 0.6);
    campusMap.addEdge(wilber, asbury, 0.7);
    campusMap.addEdge(wilber, lucas, 0.4);
    campusMap.addEdge(wilber, elizabeth, 0.7);
    campusMap.addEdge(wilber, honorBusiness, 0.1);
    
    // Library - MathZone is very close
    campusMap.addEdge(library, mathZone, 0.05); // approx 259 feet
}
...
void EagleMaps::addNewBuilding() {
    ...
    if (addConn == 'y' || addConn == 'Y') {
        ...
        for (int i = 0; i < numConnections; i++) {
            ...
            campusMap.addEdge(newBuilding, otherBuilding, distance);
        }
    }
